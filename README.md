...
> <sub><ul><li>UBUNTU PRO: SECURITY PATCHING FOR ALL OPEN SOURCE SOFTWARE ON UBUNTU FOR 10 YEARS</li><li>UBUNTU PRO LEGACY: EXTENDS SECURITY PATCHING ON UBUNTU 24.04 LTS UNTIL APRIL 2036</li></ul></sub>
