...
<summary>&ensp;Edit cloud-init.yaml and set configurations between lines 4 and 53.</summary>
...
| **[STEP 3](#step-3)** | use the **gcloud** command to provision a free Ubuntu VM with cloud-init and configure the firewall |
