...
- Proceed as a Windows or macOS user: [Set up a cloud-deployment workspace on Windows and macOS](#set-up-a-cloud-deployment-workspace-on-windows-and-macos)
- Proceed as a Linux user: [Set up a cloud-deployment workspace on Linux](#set-up-a-cloud-deployment-workspace-on-linux)
