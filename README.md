...
> Open source software dependencies of FreePBX (including Asterisk) installed from official Ubuntu LTS repositories get 12 years of security patches when free (or paid) [Ubuntu Pro](https://ubuntu.com/pro) is enabled by [attaching an Ubuntu Pro token](https://ubuntu.com/server/docs/attach-your-ubuntu-pro-subscription) for personal or commercial evaluation purposes.
